...
#define PRINT_LOAD_KERNEL 1
 
#define LINEBUFFER_PORT 1
#define LAYER1INCLUDED 0
...
#else
#define XI_KER_PROC       	KERSIZE 		//8
#define XI_PIX_PROC       	PROCSIZE 		//16
#define XI_ISTAGEBUFF_DEPTH INBUFFERSIZE 	//2048
#define XI_OSTAGEBUFF_DEPTH OUTBUFFERSIZE  	//1024
#define XI_WEIGHTBUFF_DEPTH WEIGHTBUFFERSIZE  	//1024	
#endif
