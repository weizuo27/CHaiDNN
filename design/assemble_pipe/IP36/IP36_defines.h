...
#ifndef _IP36_DEFINES_H_
#define _IP36_DEFINES_H_
...
//#define XI_DIET_CHAI_ZUPLUS	0 //Enable this Macro to reduce the resource utilization of the design to fit to smaller devices
	...
	#define PRINT_FEEDING_BUFF 0
	#define PRINT_LOAD_KERNEL 0
	
	#define LINEBUFFER_PORT 1
	#define LAYER1INCLUDED 1
	#define FUTRUE_IMPLEMENTATIONIP36


	//**** URAM ENABLE FLAGS FOR IP36/IP36.cpp
	...
	//**** CONFIGURABLE MACROS
		...
		#define XI_WEIGHTBUFF_DEPTH 1024 	//1024	
	#endif
