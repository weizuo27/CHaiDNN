...
#ifndef _IP36_DESC_H_
#define _IP36_DESC_H_
...
namespace IP36
{
	...
	typedef ap_uint<12> uLineBuffAddr_t; // depth=2048*2
	...
	ap_uint<16> pix_rows[32];
	ap_uint<16> pix_cols[32];
	ap_uint<16> current_plane_by4;
	} out_pix_struct;

	typedef struct output_pixels2_descriptor {
		ap_uint<16> pix_rows[16];
		ap_uint<16> pix_cols[16];
	} out_pix2_struct;
