...
#define IN_LINE_BUFFER_SIZE 8192
typedef ap_uint<13> inLineBuffAddr_t;

#define OUT_LINE_BUFFER_SIZE 2048
typedef ap_uint<11> outLineBuffAddr_t;
...
typedef ap_uint<16> uPlnIdxPool_t;
